    ...
    <div class="col-lg-6 col-md-6 border-right">
      ...
      <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
        ...
        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
          <label for="email" class="col-md-offset-1 col-md-2 col-sm-offset-1 col-sm-1 control-label">Email:</label>
        ...
        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
          <label for="password" class="col-md-offset-1 col-md-2 col-sm-offset-1 col-sm-1 control-label">Senha:</label>
          <div class="col-md-7 col-sm-9">
        ...
        <div class="form-group">
          <div class="col-md-offset-3 col-md-8 col-sm-offset-2">
            <div class="checkbox">
              <label>
